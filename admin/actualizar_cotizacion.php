                    ...
                    <table class="table table-borderless fs--1 mb-0">
                        <tbody>
                            <tr class="border-bottom">
                                <th class="ps-0 pt-0"><span class="fw-bold">Nombre de Empresa: </span> <span>Comisariato Del Constructor S.A.</span>
                                    <div class="text-700 fw-normal fs--1"><span class="fw-bold">Sucursal: </span>Comisariato del Constructor COMI S.A.</div>
        ...
        <div class="col-xl-8">
            ...
            <div class="card">
                <div class="card-header bg-light d-flex justify-content-between align-items-center py-1 px-1">
                    ...
                    <div class="d-flex">
                        <div class="me-2">
                            <input class="form-control form-control search-input lh-1 rounded-2 ps-4" type="text" placeholder="Buscar por codigo" id="searchInput" />
                            <div class="position-absolute top-50 start-0 translate-middle-y ms-2"><span class="fas fa-search text-400 fs--1"></span></div>
                        </div>
                        <button class="btn btn-md btn-primary" type="button" onclick="modalListProductos()"> Agregar</button>
                    </div>
                </div>
...
<script src="js/actualizar_cotizacion.js"></script>